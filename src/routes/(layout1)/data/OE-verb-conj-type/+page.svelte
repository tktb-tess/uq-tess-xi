...
<p>
  古英語の動詞活用を網羅的にまとめ、解説する。なお表記は英語版 Wiktionary
  のものに倣い、ウィン（ƿ）の代わりに w を使い、þ と ð は þ に統一する。 c, g
  の硬口蓋化音はドットで表記し、長母音はマクロンで示す。
</p>
...
<XSection title="強変化動詞">
  ...
  <p>
    古英語の強変化動詞の語幹母音は「(現在) - (直説法過去1, 3人称単数) - (その他の過去) -
    (過去分詞)」の4種類のグループ間で交替する。以下、直説法過去1,
    3人称単数の過去語幹を「第1過去語幹」、それ以外の過去語幹を「第2過去語幹」ということにする。
  ...
  <p>
    ...
    <strong>iCe - oCe - iCen</strong> と変化する不規則動詞に相当する。 なお直説法現在2人称単数の語尾
    <i>-st</i>
