...
<XSection title="子音">
  <XTable
    ...
    data={[
      ...
      ['鼻音', '', 'm', '', 'n', '', 'ŋ', ''],
      ['はじき音', '', '', '', '', 'ɽ', '', ''],
      [['接近音', { rows: 2, class: 'border-b-0' }], '中央', '', 'ʋ', 'ð', 'j', '', ''],
      ['側面', '', '', 'l', '', '', ''],
    ]}
  />
...
<XSection title="母音">
  ...
  <div class="grid cols-auto-fill-110">
    <XTable
      headRows={3}
      headCols={1}
      caption="口母音"
  ...
  <h3>二重母音</h3>
  <div class="grid cols-auto-fill-75">
    <XTable
      caption="口母音"
      headRows={1}
      headCols={1}
