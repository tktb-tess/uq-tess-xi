...
<p>
	...
	と共通で、修飾する名詞の性・格に合わせて変化する。しかし、後ろに他の数詞が来るときは名詞の性に拘わらず主格形
	<em>an</em> が使われる。
</p>
...
<p>
	また、2 <em>tvęģ</em>
	は性によって変化する。しかし、後ろに他の数詞が来るときは名詞の性に拘わらず中性形の <em>taw</em> が使用される。
</p>
...
<h4 class="text-center" style="color: red;">工事中…</h4>
